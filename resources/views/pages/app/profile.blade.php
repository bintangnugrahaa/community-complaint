...
@section('content')
    <div class="d-flex flex-column justify-content-center align-items-center gap-2">
        <img src="{{ Auth::user()->resident ? asset('storage/' . Auth::user()->resident->avatar) : asset('images/default-avatar.png') }}"
    ...
    <div class="row mt-4">
        <div class="col-6">
            <div class="card profile-stats">
                <div class="card-body">
                    <h5 class="card-title">{{ Auth::user()->resident ? Auth::user()->resident->reports->count() : 0 }}</h5>
                    ...
                    <h5 class="card-title">
                        @php
                            ...
                            if (Auth::user()->resident) {
                                $reports = Auth::user()->resident->reports;
                                foreach ($reports as $report) {
                                    if ($report->reportStatuses && $report->reportStatuses->count() > 0) {
